...
aws --endpoint $LOCALSTACK_URL sns subscribe --region $AWS_REGION --topic-arn arn:aws:sns:eu-west-2:000000000000:cdp_workflow_events --protocol sqs --notification-endpoint arn:aws:sqs:eu-west-2:000000000000:cdp_workflow_events --attributes "{\"RawMessageDelivery\": \"true\"}"
